  ...
  return (
    <div className="bg-white py-10 sm:py-16">
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6">
        <h1 className="text-3xl font-bold text-[#104591] sm:text-4xl">Leave Portal</h1>
        <div className="mt-2 h-1 w-20 bg-[#0E8B1A]" />

        <div className="mt-8 max-w-md rounded border border-[#e9e9e9] bg-[#fbfbfb] p-6">
          <p className="text-sm text-[#65676b]">
            Apply for leave and check your leave balance through the leave management portal.
          </p>
